...
NDiplomacy = {
	...
	NUM_DAYS_TO_ENABLE_KICKING_NEW_MEMBERS_OF_FACTION = 7300,			-- Number of days before being able to kick a new member of faction 
	...
	BASE_GENERATE_WARGOAL_DAILY_PP = 40.0,	-- Daily pp cost for generation of wargoals
	...
	TENSION_TIME_SCALE_START_DATE = "1924.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	GUARANTEE_COST = 9999,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 9999,
...
NAI = {
	...
	DIPLOMACY_FACTION_PLAYER_JOIN = -500,			-- Bonus for human players asking to join a faction.
